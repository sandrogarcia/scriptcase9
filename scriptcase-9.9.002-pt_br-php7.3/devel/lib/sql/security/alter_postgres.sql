...
ALTER TABLE sec_users_apps ADD CONSTRAINT users_apps_ibfk_1 FOREIGN KEY (login) REFERENCES sec_users (login) ON DELETE CASCADE;
ALTER TABLE sec_users_apps ADD CONSTRAINT users_apps_ibfk_2 FOREIGN KEY (app_name) REFERENCES sec_apps (app_name) ON DELETE CASCADE;
