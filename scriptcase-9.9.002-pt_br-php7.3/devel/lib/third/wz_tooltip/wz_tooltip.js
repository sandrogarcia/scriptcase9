...
config. CloseBtnColors	= ['#B8C9D9', '#FFFFFF', '#B8C9D9', '#3B5276']	// [Background, text, hovered background, hovered text] - use empty strings '' to inherit title colours
...
config. TitleFontColor	= '#3B5276'	// Color of title text - if '', BgColor (of tooltip body) will be used
