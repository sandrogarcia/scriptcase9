...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
		...
		$this->options = array(
            ...
            'upload_dir' => (isset($_POST['im_base_folder']) && !empty($_POST['im_base_folder']) ? $_POST['im_base_folder'].'/' : '../../../../../../../tmp/sc_tmp_upload_' . $this->get_user_id() . '/'),
...
//                )
    ...
    protected function get_unique_filename($name,
        ...
        $val = 0;
        if(isset($content_range[1]) && !empty($content_range[1]))
        {
            $val = (int) $content_range[1];
        }

        $uploaded_bytes = $this->fix_integer_overflow($val);
...
//        }
    ...
    protected function gd_orient_image($file_path, $src_img) {
        ...
        $orientation = !isset($exif['Orientation']) ? 0 : intval(@$exif['Orientation']);
