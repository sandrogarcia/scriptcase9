...
(function (d) {
    ...
    var a = d.fn.dataTable, b = d('<meta class="foundation-mq"/>').appendTo("head");
    a.ext.foundationVersion = b.css("font-family").match(/small|medium|large/) ? 6 : 5;
    b.remove();
    d.extend(a.ext.classes,
        {sWrapper: "dataTables_wrapper dt-foundation", sProcessing: "dataTables_processing panel"});
    ...
    a.ext.renderer.pageButton.foundation = function (b, l, r, s, e, i) {
        var m = new a.Api(b), t = b.oClasses, j = b.oLanguage.oPaginate, u = b.oLanguage.oAria.paginate || {}, f, h, g, v = 5 === a.ext.foundationVersion, q = function (a, n) {
            ...
            k = 0;
            for (o = n.length; k < o; k++)if (c = n[k], d.isArray(c))q(a, c); else {
                h = f = "";
                g = null;
                switch (c) {
                    case "ellipsis":
                ...
                }).append(g ? d("<" + g + "/>", {href: "#"}).html(f) : f).appendTo(a), b.oApi._fnBindAction(p, {action: c}, l))
            }
        };
