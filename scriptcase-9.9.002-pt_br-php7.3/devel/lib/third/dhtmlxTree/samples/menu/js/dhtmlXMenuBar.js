...
To use this component outside dhtmlxTree Professional please contact info@scbr.com to obtain license
 ...
 if((_isIE)&&(this.parentObject==document.body))
{
 ...
 if((_isIE)&&(this.parentObject.style.position=="absolute"))this.parentObject.style.zIndex=zIndex;
}
 ...
 if(this.lastOpenedPanel!=panel)
{
 ...
 panel.topNod.style.top = parseInt(panel.topNod.style.top)-getAbsoluteTop(panel.topNod.parentNode);
 panel.topNod.style.left = parseInt(panel.topNod.style.left)-getAbsoluteLeft(panel.topNod.parentNode);
}
