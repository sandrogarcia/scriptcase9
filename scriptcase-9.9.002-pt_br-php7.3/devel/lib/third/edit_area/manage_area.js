	...
	EditArea.prototype.get_selection_infos= function(){
		...
		// ----------------------------------scriptcase-------------------------------------------------------------------------------------------------
		 if (document.getElementById("n_row_macro_complete")) 
		 {
			if (IsMacroComplete() && (document.getElementById("n_row_macro_complete").value != sel["line_start"] || sel["curr_pos"] < document.getElementById("n_col_macro_complete").value || sel["curr_pos"] > (parseInt(document.getElementById("n_col_macro_complete").value) + 1))) 
			{
