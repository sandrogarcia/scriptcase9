editAreaLoader.load_syntax["php"] = {
	...
	,'STYLES' : {
		'COMMENTS': 'color: #FF8000;'
		,'QUOTESMARKS': 'color: #DD0000;'
		,'KEYWORDS' : {
			'reserved' : 'color: #007700;'
			,'functions' : 'color: #007700;'
			,'statements' : 'color: #007700;'
			}
		,'OPERATORS' : 'color: #007700;'
		,'DELIMITERS' : 'color: #007700;'
		,'REGEXPS' : {
			'variables' : 'color: #0000bb;'
		}		
	}
	,'AUTO_COMPLETION' :  {
