...
function getDataAjax(url, str_func_retorno, isAsync, debug) {
    doAjaxServer(url, "", str_func_retorno, isAsync, debug);
}

function postDataAjax(url, params, str_func_retorno, isAsync, debug) {
    doAjaxServer(url, params, str_func_retorno, isAsync, debug);
}
...
function callReloadModalPanel(type) {
    ...
    var background_color = {
        ...
        gear: "background-color: #FFF;",
        party: "background-color: #000;"
    };
    var image = {
        black: "page_loader_white.gif",
        gray: "page_loader_white.gif",
        white: "page_loader_black.gif",
        gear: "page_loader_gears.gif",
        party: "party_loader.gif"
    };
