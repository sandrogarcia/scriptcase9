...
{
    /*
    Botoes de "detalhe" e "edicao de aplicacao" da consulta, quando utilizando a configuracao visual da barra de acoes,
    passam como inicio da string de hint o valor "#SC_ACTBAR_BTN#"
    */
    $isActionBarButton = false;
    if ('#SC_ACTBAR_BTN#' == substr($sHint, 0, 15)) {
        $sHint = substr($sHint, 15);
    ...
    // pholder-actbar - placeholder para classe da actionbar
    $str_class_additional = "pholder-actbar ";
            ...
            case 'only_fontawesomeicon':
                if(!empty($arr_buttons[$sBtn]['fontawesomeicon']))
                {
                    ...
                    if ($isActionBarButton) {
                        $sCodigo = str_replace('pholder-actbar ', 'sc-actionbar-fa ', $sCodigo);
                    }
                }
                break;
    ...
    $sCodigo = str_replace('pholder-actbar ', '', $sCodigo);
