    ...
    <tr class="nmTrAttr nmTrHover <?php echo isset($arr_data['tr_class']) ? $arr_data['tr_class'] : ''; ?>" id="id_tr_<?php echo $arr_data['name']; ?>" <?php echo $arr_data['tr_style']; ?>>
        ...
        <td class="nmAttrValue <?php echo $str_class; ?>" style="text-align: left; vertical-align: top; white-space: nowrap">
            <table class="sc-smile-table">
                ...
                <tr>
                    <td><i class="sc-smile-item far fa-thumbs-up"></i></td>
                    <td><input type="text" class="sc-smile-input nmInput" name="rating_thumb_values[]" value="<?php echo $arr_data['value'][0]; ?>" onChange="<?php echo $nm_config['form_modif2'] ?>" <?php echo $disableInput; ?> /></td>
                    <td><input type="text" class="nmInput" name="rating_thumb_hints[]" value="<?php echo $arr_data['hints'][0]; ?>" onChange="<?php echo $nm_config['form_modif2'] ?>" <?php echo $disableInput; ?> /></td>
                </tr>
                <tr>
                    <td><i class="sc-smile-item far fa-thumbs-down"></i></td>
                    <td><input type="text" class="sc-smile-input nmInput" name="rating_thumb_values[]" value="<?php echo $arr_data['value'][1]; ?>" onChange="<?php echo $nm_config['form_modif2'] ?>" <?php echo $disableInput; ?> /></td>
                    <td><input type="text" class="nmInput" name="rating_thumb_hints[]" value="<?php echo $arr_data['hints'][1]; ?>" onChange="<?php echo $nm_config['form_modif2'] ?>" <?php echo $disableInput; ?> /></td>
                </tr>
            </table>
        </td>
