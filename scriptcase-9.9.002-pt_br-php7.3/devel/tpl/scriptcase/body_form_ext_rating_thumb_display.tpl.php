        ...
        <td class="nmAttrValue <?php echo $str_class; ?>" style="text-align: left; vertical-align: top; white-space: nowrap">
            <table class="sc-smile-table">
                <tr>
                    ...
                    <td>
                        <i class="sc-smile-item far fa-thumbs-up"></i>
                        <i class="sc-smile-item far fa-thumbs-down"></i>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <i class="sc-smile-item fas fa-thumbs-up"></i>
                        <i class="sc-smile-item fas fa-thumbs-down"></i>
                    </td>
                </tr>
            </table>
        </td>
