    ...
    <tr class="nmTrAttr nmTrHover <?php echo isset($arr_data['tr_class']) ? $arr_data['tr_class'] : ''; ?>" id="id_tr_<?php echo $arr_data['name']; ?>" <?php echo $arr_data['tr_style']; ?>>
        ...
        <td class="nmAttrValue <?php echo $str_class; ?>" style="text-align: left; vertical-align: top; white-space: nowrap">
            <table class="sc-smile-table">
                ...
                <tr>
                    <td>
                        <i class="sc-smile-item far fa-star" style="color: <?php echo $arr_data['value']; ?>"></i>
                        <i class="sc-smile-item fas fa-star" style="color: <?php echo $arr_data['value']; ?>"></i>
                    </td>
                    <td><input type="text" class="sc-smile-input sc-rating-color-picker nmInput" name="<?php echo $arr_data['name']; ?>" value="<?php echo $arr_data['value']; ?>" onChange="<?php echo $nm_config['form_modif2'] ?>" <?php echo $disableInput; ?> /></td>
                </tr>
            </table>
        </td>
