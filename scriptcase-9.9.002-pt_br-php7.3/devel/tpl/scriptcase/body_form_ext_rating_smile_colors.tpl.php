    ...
    <tr class="nmTrAttr nmTrHover <?php echo isset($arr_data['tr_class']) ? $arr_data['tr_class'] : ''; ?>" id="id_tr_<?php echo $arr_data['name']; ?>" <?php echo $arr_data['tr_style']; ?>>
        ...
        <td class="nmAttrValue <?php echo $str_class; ?>" style="text-align: left; vertical-align: top; white-space: nowrap">
            <table class="sc-smile-table">
                ...
                <tr>
                    <td>
                        <i class="sc-smile-item far fa-angry" style="color: <?php echo $arr_data['value'][0]; ?>"></i>
                        <i class="sc-smile-item sc-smile-stroke fas fa-angry" style="color: <?php echo $arr_data['value'][0]; ?>"></i>
                    </td>
                ...
                <tr>
                    <td>
                        <i class="sc-smile-item far fa-frown" style="color: <?php echo $arr_data['value'][1]; ?>"></i>
                        <i class="sc-smile-item sc-smile-stroke fas fa-frown" style="color: <?php echo $arr_data['value'][1]; ?>"></i>
                    </td>
                ...
                <tr>
                    <td>
                        <i class="sc-smile-item far fa-meh" style="color: <?php echo $arr_data['value'][2]; ?>"></i>
                        <i class="sc-smile-item sc-smile-stroke fas fa-meh" style="color: <?php echo $arr_data['value'][2]; ?>"></i>
                    </td>
                    <td><input type="text" class="sc-smile-input sc-rating-color-picker nmInput" name="<?php echo $arr_data['name']; ?>[]" value="<?php echo $arr_data['value'][2]; ?>" onChange="<?php echo $nm_config['form_modif2'] ?>" <?php echo $disableInput; ?> /></td>
                </tr>
                <tr>
                    <td>
                        <i class="sc-smile-item far fa-smile" style="color: <?php echo $arr_data['value'][3]; ?>"></i>
                        <i class="sc-smile-item sc-smile-stroke fas fa-smile" style="color: <?php echo $arr_data['value'][3]; ?>"></i>
                    </td>
                    <td><input type="text" class="sc-smile-input sc-rating-color-picker nmInput" name="<?php echo $arr_data['name']; ?>[]" value="<?php echo $arr_data['value'][3]; ?>" onChange="<?php echo $nm_config['form_modif2'] ?>" <?php echo $disableInput; ?> /></td>
                </tr>
                <tr>
                    <td>
                        <i class="sc-smile-item far fa-laugh-beam" style="color: <?php echo $arr_data['value'][4]; ?>"></i>
                        <i class="sc-smile-item sc-smile-stroke fas fa-laugh-beam" style="color: <?php echo $arr_data['value'][4]; ?>"></i>
                    </td>
                    <td><input type="text" class="sc-smile-input sc-rating-color-picker nmInput" name="<?php echo $arr_data['name']; ?>[]" value="<?php echo $arr_data['value'][4]; ?>" onChange="<?php echo $nm_config['form_modif2'] ?>" <?php echo $disableInput; ?> /></td>
                </tr>
            </table>
        </td>
