...
class diagnosis
{
	...
	function getArrLang()
	{
		...
		if(true || $this->getEnvLang()=="pt_br")
		{
			...
			$arr_lang['sc_write_perm'] 		= "Permissão de Escrita no ScriptCase";
			$arr_lang['sess_write_perm'] 	= "Permissão de Escrita na Sessão";
			$arr_lang['acesso_internet'] 	= "Acesso a Internet";
			$arr_lang['acesso_checando'] 	= "Verificando conexão com internet";
			$arr_lang['zendid_perm'] 		= "Permissão de Executar ZendId";
			...
			$arr_lang['campos_sem_apl'] 	= "Campos Sem Aplicação";
			$arr_lang['sc_licence'] 		= "licença do ScriptCase";
			$arr_lang['n_connections'] 		= "Número de Conexões";
			$arr_lang['licence_tipo'] 		= "Tipo da licença";
			$arr_lang['licence_versao'] 	= "Versão da licença";
			$arr_lang['data_expiracao'] 	= "Data Licença";
			$arr_lang['licenciado_para'] 	= "Licenciado Para";
			$arr_lang['comando_select'] 	= "Comando Select";
			$arr_lang['sc_versao'] 			= "Versão do ScriptCase";
