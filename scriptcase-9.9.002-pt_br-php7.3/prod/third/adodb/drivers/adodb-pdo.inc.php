...
class ADODB_pdo extends ADOConnection {
    ...
    function _connect($argDSN, $argUsername="", $argPassword="", $argDatabasename="", $arrExtraArgs=array(), $charset='')
    {
        ...
        if ('odbc' != $this->dsnType && 'sqlite' != $this->dsnType && 'mysql' != $this->dsnType && 'pgsql' != $this->dsnType && 'sqlsrv' != $this->dsnType && 'utf8' == $charset) {
            $argDSN .= ';charset=utf8';
        }
    ...
    {
        if(isset($this->_driver) && !empty($this->_driver) && method_exists($this->_driver, "BlobEncode"))
        {
    ...
    {
        if(isset($this->_driver) && !empty($this->_driver) && method_exists($this->_driver, "BlobDecode"))
        {
    ...
    {
        if(isset($this->_driver) && !empty($this->_driver) && method_exists($this->_driver, "UpdateBlob"))
        {
            if ($this->debug) {
