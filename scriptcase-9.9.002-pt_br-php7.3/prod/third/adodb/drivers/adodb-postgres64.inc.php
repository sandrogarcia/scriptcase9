...
WHERE relkind in ('r','v') AND (c.relname='%s' or c.relname = lower('%s'))
 and c.relnamespace=n.oid and n.nspname='%s'
	...
	var $metaDefaultsSQL = "SELECT d.adnum as num, pg_get_expr(d.adbin, d.adrelid) as def from pg_attrdef d, pg_class c, pg_namespace n where d.adrelid=c.oid AND c.relnamespace=n.oid AND (n.nspname='%s' OR '%s'='') AND c.relname='%s' order by d.adnum";
...
// Warning: This compilation does not support pg_affected_rows() in adodb-postgres.inc.php on line 44
