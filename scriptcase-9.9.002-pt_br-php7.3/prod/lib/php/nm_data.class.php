...
/*                        $str_result .= (10 > $this->mSeg) ? ("0" . $this->mSeg) : $this->mSeg; alt. para permitir decimais nos segundos*/
    ...
    function MesExtenso($opcao = "int")
    {
        ...
        $mes["pt_br"]["int"] = array("Janeiro", "Fevereiro", "Mar�o", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro");
    ...
    function DiaSemana($opcao = "int")
    {
        ...
        $dia_arr["pt_br"]["int"] = array("Domingo", "Segunda-Feira", "Ter�a-Feira", "Quarta-Feira", "Quinta-Feira", "Sexta-Feira", "S�bado");
...
/*-- mantis 0021637 --*/
        $mesmo_mes = ($ano_1. $mes_1 == $ano_2 .$mes_2) ? true : false;
/*-----*/
        $anos = $ano_2 - $ano_1;
        $meses = 0;
        $dias = 0;
...
/*        if ($dias != 0 && $dias == $dias_meses[$mes_1 + 1]) */
        ...
        $dias_ult_mes = ($mesmo_mes) ? $dias_meses[$mes_1] : $dias_meses[$mes_1 + 1];
        if ($dias != 0 && $dias == $dias_ult_mes)
/*-----*/
        {
            $dias = 0;
            $meses++;
...
//-- Calcula diferen�a de horas: retorna array com horas, minutos e segundos
...
//-- Calcula nova data em fun��o de incremento ou decremento de dias, meses e anos
