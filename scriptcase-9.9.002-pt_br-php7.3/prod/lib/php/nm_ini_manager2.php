                    ...
                    <?php foreach ($gw_data as $field_name => $value): ?>
                        <tr class="row">
                            ...
                            <td class="nmLineV3">
                                ...
                                <select name="<?php echo $k; ?>[<?php echo $field_name; ?>]" class="nmInput form-control" required="required">
                            ...
                            <div class="ui action input">
                                <input type="text"  name="<?php echo $k; ?>[<?php echo $field_name; ?>]" required="required" <?=$on_change?>
                                       placeholder="<?php echo  $nm_lang['api_gw_sett'][$field_name ."_placeholder"]; ?>" class="form-control" style="width: 84%;"
                                       value="<?php echo(isset($api['settings'][$field_name]) ? $api['settings'][$field_name] : '') ?>"
/>
                                <button class="ui button primary nmButton" onclick="openAuthGoogle();">Auth</button>
                            </div>
                            <?php elseif($value['type'] == 'textarea'): ?>
                            <textarea class="nmInput form-control" name="<?php echo $k; ?>[<?php echo $field_name; ?>]" required="required" <?=$on_change?> rows="7" style="height:auto"
                                   placeholder="<?php echo  $value['placeholder']; ?>"><?php echo(isset($api['settings'][$field_name]) ? $api['settings'][$field_name] : '') ?></textarea>

                            <?php else: ?>
                            <input type="<?php echo isset($value['type'])? $value['type'] : 'text'; ?>" class="nmInput form-control"
                             name="<?php echo $k; ?>[<?php echo $field_name; ?>]" required="required" <?=$on_change?>
